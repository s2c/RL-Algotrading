...
from keras.layers import Conv1D, Dense, Flatten, merge, MaxPooling2D, Input, AveragePooling2D, Lambda, Merge, Activation, Embedding
...
class Networks(object):
    ...
    def actor_network(input_shape, action_size, learning_rate):
        ...
        # print(action_size)
        model = Sequential()
        model.add(Conv1D(32, 6, input_shape=[input_shape,1]))
